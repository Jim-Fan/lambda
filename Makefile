.PHONY: tags test example

lambda: parser.tab.c lexer.yy.c lambda.h lambda.c secd/secd.h secd/secd.c main.c
	gcc -std=c99 -g -o $@ lexer.yy.c parser.tab.c lambda.c secd/secd.c main.c
